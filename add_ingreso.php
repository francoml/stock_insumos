 ...
 <body>
	...
	<form method="post" action="add_ingreso2.php" class="clearfix">
        ...
        <div class="col-md-20">
			...
			<?php echo $prov['nombre'] ?></option> <!--va a buscar el proveedor por su id, pero va a mostrar su nombre-->
			<?php endforeach; ?>
			</select>
			</div>			
		...
		<div class="col-md-7">
			...
			<input type="number" class="form-control" autocomplete="off" name="ingreso-cantidad" placeholder="" tabindex="9">
			</div>
			</div>
