...
<div class="container-fluid col-12 border border-light border-2 rounded box">
  ...
  <div class="col-md-3">
    <a href="add_salida.php" class="btn btn-dark hoverAccept"><i class="bi bi-plus-square"></i> AGREGAR NUEVA SALIDA</a>
  </div>
        ...
        <?php foreach ($salidas as $salida) : ?>
          <tr>
            ...
            <td class="text-center">
              <div class="btn-group">
                <a href="edit_salida.php?id=<?php echo (int)$salida['id']; ?>" class="btn btn-info btn-sm" title="Editar" data-toggle="tooltip">
                  <i class="bi bi-pencil-square"></i>
                </a>
                <a href="delete_salida.php?id=<?php echo (int)$salida['id']; ?>" class="btn btn-danger btn-sm" title="Eliminar" data-toggle="tooltip">
