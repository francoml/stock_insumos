...
if (isset($_POST['remito'])) {
	...
	if (empty($errors)) {
		...
		if ($result && $db->affected_rows() === 1) {
			...
			redirect('edit_reporte_ingresos.php?id=' . $remito['id'], false);
		}
	} else {
...
<form method="post" action="edit_reporte_ingresos.php?id=<?php echo (int)$remito['id'] ?>">
