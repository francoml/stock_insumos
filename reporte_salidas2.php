    ...
    <div class="col-md-12">
      <div class="panel panel-default">
		...
		<strong>
            ...
            <span>HISTORIAL DE SALIDAS DEL "<?php echo $inicio;?>" AL "<?php echo $fin;?>"</span>
          </strong>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_reporte_salidas.php?id=<?php echo (int)$result['id'];?>" class="btn btn-info btn-xs"  title="Editar" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a href="delete_reporte_salidas.php?id=<?php echo (int)$result['id'];?>" class="btn btn-danger btn-xs"  title="Eliminar" data-toggle="tooltip">
